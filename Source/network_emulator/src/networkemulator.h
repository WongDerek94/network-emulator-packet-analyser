/*-----------------------------------------------------------------------------------------------------------------------------------
 * NETWORKEMULATOR CLASS DECLARATION FILE:      networkemulator.h
 *
 ...
 *
 * NOTES:
 * Declaration file for NetworkEmulator class
 * ----------------------------------------------------------------------------------------------------------------------------------*/
 ...
 *
 * NOTES:
 * Main class responsible for the functionality of the application
 * ----------------------------------------------------------------------------------------------------------------------------------*/
